---
name: refactor
description: "Perform safe, test-driven refactoring without behavior changes. Use this English-default variant when users call `/refactor`, ask for structure cleanup, or want duplication and technical debt reduced."
---

# Refactor

This is the English-default variant of `refactor`.

## Load only what you need

- [work-order.md](../shared/references/work-order.md): refactoring work-order format.
- [refactoring-checklist.md](../shared/references/refactoring-checklist.md): safety checklist.
- [refactoring-patterns.md](../shared/references/refactoring-patterns.md): pattern selection guide.
