---
name: review
description: "Review code changes for regressions, security issues, and missing tests. Use this English-default variant when users call `/review`, ask for a diff review, or need concrete fix guidance after implementation."
---

# Review

This is the English-default variant of `review`.
