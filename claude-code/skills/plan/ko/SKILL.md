---
name: plan
description: "Turn a request into executable work orders. Use this Korean-default variant when users ask for planning before implementation, call `/plan`, or need a request split into small verifiable tasks."
---

# Plan

This is the Korean-default variant of `plan`.
