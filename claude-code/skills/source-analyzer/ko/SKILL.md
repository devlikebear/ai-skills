...
- [tutorial-template.md](../shared/references/tutorial-template.md): tutorial and clone-coding structure.
- [refactor-template.md](../shared/references/refactor-template.md): refactor work-order structure.
- [tidy-first-rules.md](../shared/references/tidy-first-rules.md): TIDY rule mapping.
- [security-triage-checklist.md](../shared/references/security-triage-checklist.md): security fallback checks.
- [checkpoint-template.md](../shared/references/checkpoint-template.md): manual checkpoint fallback.
- `${CLAUDE_SKILL_DIR}/shared/scripts/checkpoint_manager.py`: resumable checkpoint session manager.
...
```bash
CHECKPOINT_SCRIPT="${CLAUDE_SKILL_DIR}/shared/scripts/checkpoint_manager.py"
...
- Follow [refactor-template.md](../shared/references/refactor-template.md) exactly.
- For each issue include evidence, completion criteria, and test criteria.
- Check security references first, then fall back to [security-triage-checklist.md](../shared/references/security-triage-checklist.md).
