---
name: implement
description: "Execute an approved work order directly with small, test-proven code changes. Use this English-default variant when users call `/implement`, move from planning into implementation, or want Claude to make the code changes itself."
---
