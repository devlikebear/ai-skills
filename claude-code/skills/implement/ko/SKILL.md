---
name: implement
description: "Execute an approved work order directly with small, test-proven code changes. Use this Korean-default variant when users call `/implement`, move from planning into implementation, or want Claude to make the code changes itself."
---

# Implement

This is the Korean-default variant of `implement`.

## Load only what you need

- [work-order.md](../shared/references/work-order.md): required work-order format.
...
2. Confirm or rewrite the work order using the [work-order template](../shared/references/work-order.md).
