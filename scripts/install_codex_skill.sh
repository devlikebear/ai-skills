...
Usage:
  ...
  scripts/install_codex_skill.sh --list-languages <skill-name>
  scripts/install_codex_skill.sh <skill-name> <language>
  scripts/install_codex_skill.sh --all <language>

Examples:
  scripts/install_codex_skill.sh source-analyzer ko
  scripts/install_codex_skill.sh source-analyzer en
  CODEX_HOME="$HOME/.codex" scripts/install_codex_skill.sh --all en
EOF
}
