---
name: plan-for-codex
description: "Turn a request into executable work orders for Codex. Use this English-default variant when users ask for planning before implementation, call `/plan`, or need a request split into small verifiable tasks."
---

# Plan

This is the English-default variant of `plan-for-codex`.
