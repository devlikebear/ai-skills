---
name: implement
description: "Execute an approved work order directly with small, test-proven code changes. Use this Korean-default variant when users call `/implement`, move from planning into implementation, or want Codex to make the code changes itself."
---
